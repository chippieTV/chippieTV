...
export const data: CV = {
	...
	"Clients": {
		...
		"pu": {
			...
			"client_description_l": "Purdey is a true luxury brand, famous for their guns which are handmade and have a starting price of around £80,000. They also sell luxury clothing and accessories for the shooting customer.",
			"tags": ["fashion"],
			"projects": [
				{
					"project_id": "pu-1",
